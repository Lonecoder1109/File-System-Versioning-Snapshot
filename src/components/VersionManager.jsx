...
const VersionManager = ({ files, onRefresh }) => {
    ...
    const createVersion = async (fileId) => {
        try {
            const response = await fetch(
                `/api/versions?fileId=${fileId}&description=Manual version`,
                { method: 'POST' }
            );
    ...
    return (
        <div className="grid" style={{ gap: '2rem' }}>
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <button
                            ...
                            onClick={() => createVersion(selectedFile.id)}
                        >
                            <Plus size={16} />
                            Create Version
                        </button>
                    ...
                    <div className="card-body">
                        {selectedFile.versions === 0 ? (
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                {/* Version Items (Mock data for demonstration) */}
                                {Array.from({ length: selectedFile.versions }).map((_, index) => {
                                    const versionNum = selectedFile.versions - index;
                                    return (
                                        <div
                                            key={index}
                                            style={{
                                        ...
                                        >
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style={{
                                                            ...
                                                            Created: {new Date(Date.now() - index * 3600000).toLocaleString()}
                                                        </div>
                                                    </div>
                                                ...
                                                <p style={{
                                                    ...
                                                    {index === 0 ? 'Latest version' : `Version ${versionNum} snapshot`}
                                                </p>
            ...
            <div className="card">
                <div className="card-header">
                    <h3 className="card-title">Contextual Versioning Features</h3>
                </div>
                <div className="card-body">
                    <div className="grid grid-2" style={{ gap: '1rem' }}>
                        <div style={{
                            ...
                            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
                                Tag versions with meaningful labels like "stable", "beta", "production"
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
                                Store custom metadata with each version including author, purpose,
                    ...
                    <div className="modal" onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <h3 className="modal-title">
                                Add Tag to Version {selectedVersion}
                            </h3>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="e.g., stable, beta, production"
                                autoFocus
                            />
                        </div>
                        <div className="form-group">
